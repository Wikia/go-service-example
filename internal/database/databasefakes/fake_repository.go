...
type FakeRepository struct {
	AddEmployeeStub        func(context.Context, *database.EmployeeDBModel) error
	addEmployeeMutex       sync.RWMutex
	addEmployeeArgsForCall []struct {
		arg1 context.Context
		arg2 *database.EmployeeDBModel
	}
	...
	GetAllEmployeesStub        func(context.Context) ([]database.EmployeeDBModel, error)
	getAllEmployeesMutex       sync.RWMutex
	getAllEmployeesArgsForCall []struct {
		arg1 context.Context
	}
	getAllEmployeesReturns struct {
		result1 []database.EmployeeDBModel
		result2 error
	}
	...
	GetEmployeeStub        func(context.Context, int64) (*database.EmployeeDBModel, error)
...
func (fake *FakeRepository) AddEmployee(arg1 context.Context, arg2 *database.EmployeeDBModel) error {
...
func (fake *FakeRepository) AddEmployeeCalls(stub func(context.Context, *database.EmployeeDBModel) error) {
	fake.addEmployeeMutex.Lock()
	defer fake.addEmployeeMutex.Unlock()
	fake.AddEmployeeStub = stub
}

func (fake *FakeRepository) AddEmployeeArgsForCall(i int) (context.Context, *database.EmployeeDBModel) {
	fake.addEmployeeMutex.RLock()
	defer fake.addEmployeeMutex.RUnlock()
...
func (fake *FakeRepository) GetAllEmployees(arg1 context.Context) ([]database.EmployeeDBModel, error) {
...
func (fake *FakeRepository) GetAllEmployeesCalls(stub func(context.Context) ([]database.EmployeeDBModel, error)) {
	fake.getAllEmployeesMutex.Lock()
...
func (fake *FakeRepository) GetAllEmployeesReturns(result1 []database.EmployeeDBModel, result2 error) {
	fake.getAllEmployeesMutex.Lock()
	defer fake.getAllEmployeesMutex.Unlock()
...
func (fake *FakeRepository) GetAllEmployeesReturnsOnCall(i int, result1 []database.EmployeeDBModel, result2 error) {
	fake.getAllEmployeesMutex.Lock()
	defer fake.getAllEmployeesMutex.Unlock()
	fake.GetAllEmployeesStub = nil
...
func (fake *FakeRepository) GetEmployee(arg1 context.Context, arg2 int64) (*database.EmployeeDBModel, error) {
...
func (fake *FakeRepository) GetEmployeeCalls(stub func(context.Context, int64) (*database.EmployeeDBModel, error)) {
	fake.getEmployeeMutex.Lock()
...
func (fake *FakeRepository) GetEmployeeReturns(result1 *database.EmployeeDBModel, result2 error) {
	fake.getEmployeeMutex.Lock()
	defer fake.getEmployeeMutex.Unlock()
...
func (fake *FakeRepository) GetEmployeeReturnsOnCall(i int, result1 *database.EmployeeDBModel, result2 error) {
	fake.getEmployeeMutex.Lock()
	defer fake.getEmployeeMutex.Unlock()
	fake.GetEmployeeStub = nil
...
var _ database.Repository = new(FakeRepository)
