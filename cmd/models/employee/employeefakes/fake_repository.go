...
type FakeRepository struct {
	AddEmployeeStub        func(context.Context, *employee.Employee) error
	addEmployeeMutex       sync.RWMutex
	addEmployeeArgsForCall []struct {
		arg1 context.Context
		arg2 *employee.Employee
	}
	...
	GetEmployeeStub        func(context.Context, int64) (*employee.Employee, error)
...
func (fake *FakeRepository) AddEmployee(arg1 context.Context, arg2 *employee.Employee) error {
...
func (fake *FakeRepository) AddEmployeeCalls(stub func(context.Context, *employee.Employee) error) {
	fake.addEmployeeMutex.Lock()
	defer fake.addEmployeeMutex.Unlock()
	fake.AddEmployeeStub = stub
}

func (fake *FakeRepository) AddEmployeeArgsForCall(i int) (context.Context, *employee.Employee) {
	fake.addEmployeeMutex.RLock()
	defer fake.addEmployeeMutex.RUnlock()
...
func (fake *FakeRepository) GetAllEmployees(arg1 context.Context) ([]employee.Employee, error) {
...
func (fake *FakeRepository) GetAllEmployeesCalls(stub func(context.Context) ([]employee.Employee, error)) {
	fake.getAllEmployeesMutex.Lock()
...
func (fake *FakeRepository) GetAllEmployeesReturns(result1 []employee.Employee, result2 error) {
	fake.getAllEmployeesMutex.Lock()
	defer fake.getAllEmployeesMutex.Unlock()
...
func (fake *FakeRepository) GetAllEmployeesReturnsOnCall(i int, result1 []employee.Employee, result2 error) {
	fake.getAllEmployeesMutex.Lock()
	defer fake.getAllEmployeesMutex.Unlock()
	fake.GetAllEmployeesStub = nil
...
func (fake *FakeRepository) GetEmployee(arg1 context.Context, arg2 int64) (*employee.Employee, error) {
...
func (fake *FakeRepository) GetEmployeeCalls(stub func(context.Context, int64) (*employee.Employee, error)) {
	fake.getEmployeeMutex.Lock()
...
func (fake *FakeRepository) GetEmployeeReturns(result1 *employee.Employee, result2 error) {
	fake.getEmployeeMutex.Lock()
	defer fake.getEmployeeMutex.Unlock()
...
func (fake *FakeRepository) GetEmployeeReturnsOnCall(i int, result1 *employee.Employee, result2 error) {
	fake.getEmployeeMutex.Lock()
	defer fake.getEmployeeMutex.Unlock()
	fake.GetEmployeeStub = nil
...
var _ employee.Repository = new(FakeRepository)
