...
func GetEmployee(ctx context.Context, db *gorm.DB, employeeID int64) (*Employee, error) {
...
func DeleteEmployee(ctx context.Context, db *gorm.DB, employeeID int64) (err error) {
