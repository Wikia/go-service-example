...
func (s MainServerImpl) GetAllEmployees(ctx echo.Context) error {
...
func (s MainServerImpl) CreateEmployee(ctx echo.Context) error {
...
func (s MainServerImpl) FindEmployeeByID(ctx echo.Context, employeeID int64) error {
	logger := logging.FromEchoContext(ctx).Sugar()
...
func (s MainServerImpl) DeleteEmployee(ctx echo.Context, employeeID int64) error {
	logger := logging.FromEchoContext(ctx).Sugar()
